<template>
  ...
  <div class="container mt-4 mt-md-5">
      <div class="home-container shadow">
        <h1 class="mb-5">Teste DACXI - Consumindo API coingeko</h1>
      <div class="row">
       ...
       <div class="row">    
         <div class="col-12 col-md-5">
          ...
          <div class="col-12 col-md-2 align-self-end">
            <button @click="priceFilter" class="btn btn-primary mt-2" style="width: 100%;">Filtrar</button>
          </div>
      </div>
      <div class="row mt-4">
        <div class="col">
